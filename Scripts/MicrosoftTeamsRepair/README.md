...
**Notes:** the home directory is resolved via `dscl` rather than assuming `/Users/<name>`, and a force-quit fallback ensures Teams is not running while its caches are deleted — otherwise it rewrites them on exit and undoes the repair.
