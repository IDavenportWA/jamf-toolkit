...
**Notes:** membership is tested by exact match rather than by grepping the member list, which would substring-match (`bob` against `bobby`) and treat an unset username as a match.
