...
**Ordering matters here:** the warning and quit happen *before* the install. Installing over a running Chrome and warning afterwards updates the browser underneath the user, which is what an earlier version of this script did.
