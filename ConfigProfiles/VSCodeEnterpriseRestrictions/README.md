...
Enforcement is by extension identifier, so it is evadable by a determined person and is not a hard security boundary. What it removes is *accidental* adoption, which is the bulk of the actual risk.
