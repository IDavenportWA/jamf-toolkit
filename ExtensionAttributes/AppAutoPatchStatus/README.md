...
**Notes:** status is derived from the exit code when a receipt omits it, output is capped at 50 titles to keep inventory records manageable, and a missing receipts folder reports explicitly rather than returning empty.
